...
> Statut : ✅ MVP implémenté en V0.5 — saison Top 14 complète + système humain.
> Document **vivant**, mis à jour à chaque décision prise.

## 📋 État V0.5

- ✅ MVP étroit (1 club Top 14, 1 saison) — V0.3
- ✅ Boucle hebdomadaire condensée (préparation + match) — V0.3
- ✅ Boucle saisonnière (26 journées + barrages + demi + finale) — V0.3
- ✅ Système humain v0 (5-6 traits + mood + relations + 5 events) — V0.4
- ⬜ Boucle 5 jours actifs détaillée (Lun/Mar/Mer/Jeu séparés) — V0.6 quand l'humain justifie cette granularité
- ⬜ Mode défi / sandbox / rapide — post-v1
- ⬜ Progression méta entre parties — post-v1
