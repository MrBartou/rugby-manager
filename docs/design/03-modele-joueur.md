...
> Statut : ✅ Implémenté en V0.4 — toutes les sections principales sont en code.

## 📋 État V0.5

- ✅ Échelle hybride 0-100 / S-A-B-C-D — `src/ui/components/AttributeBar.tsx`
- ✅ 3 catégories d'attributs + sub-stats poste — `src/engine/types.ts`
- ✅ 30 traits dans 5 catégories avec exclusivités — `src/engine/human/traits.ts`
- ✅ 5-6 traits par joueur, génération déterministe — `src/engine/human/trait-generator.ts`
- ✅ Mood calculé en continu, 7 sources, top 3 modificateurs affichés — `src/engine/human/mood.ts`
- ✅ Graphe de relations (435 paires possibles, score -100..+100, 5 types) — `src/engine/human/relationships.ts`
- ✅ Évolution des relations après match
- ✅ Caractéristiques cachées (potentiel, ambition, déterminisme, loyauté, adaptabilité) — typées
- ⬜ Évolution de la forme et de la fatigue par joueur match-à-match (V0.6)
- ⬜ Blessures dynamiques (V0.6)
