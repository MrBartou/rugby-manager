...
> Statut : ✅ Tous sous-systèmes V0.1+ implémentés. Mêlée approfondie en V0.2 (duel technique).

## 📋 État V0.5

- ✅ Granularité par phase (~75 phases/match) — `src/engine/match/session.ts`
- ✅ 5 sous-systèmes : `scrum.ts`, `lineout.ts`, `ruck.ts`, `openplay.ts`, `kicking.ts`
- ✅ Mêlée V0.2 : duel technique (poussée + technique + gainage) + dominance cumulée
- ✅ 5 live moments interactifs (mi-temps, pénalité ambigüe, cadre fatigué, pression défensive, crunch time)
- ✅ Voix de staff sur chaque option de live moment (V0.4 phase 3)
- ✅ Stats individuelles agrégées (essais, place kicks)
- ✅ Calibration vs cibles V1 : 9/12 vertes (4.77 essais, 73 phases, 64% pen, 3% draws)
- ✅ Visualisation 2D top-down SVG — `src/ui/components/PitchView.tsx`
- ⬜ Approfondissement touche/maul (V0.6 — premier sous-système discriminant après mêlée)
- ⬜ Cartons jaunes/rouges (V0.6)
- ⬜ Stats individuelles fines (plaquages, mètres parcourus, turnovers) — V0.6
