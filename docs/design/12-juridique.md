...
> Statut : ⚠️ Critique — décisions à prendre AVANT V0.9 bêta privée.

## 📋 État V0.5

- ✅ Phase dev V0.x : noms réels Top 14 saisis manuellement (chemin 3 hybride), interne uniquement
- ⬜ **Décision licence avant V0.9** : chemin A (LNR officielle), B (fictifs proches + mods), ou C (licence partielle)
- ⬜ EULA rédigée
- ⬜ Politique de confidentialité (V1.0)
- ⬜ RGPD (V2.0 online uniquement)
