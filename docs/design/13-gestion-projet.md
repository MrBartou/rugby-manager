...
> Statut : ✅ V0.1 → V0.5 livrés. Voir [STATUS.md](../STATUS.md) pour l'état détaillé.

## 📋 État V0.5

- ✅ V0.1 — Proto moteur match (calibration 9/12 cibles vertes)
- ✅ V0.2 — Vertical slice "1 match jouable" (live moments, narratif, terrain SVG, save)
- ✅ V0.3 — Saison Top 14 complète (14 clubs, calendrier, classement, phases finales, compo manuelle)
- ✅ V0.4 — Système humain v0 (traits + mood + relations + 5 events + 8 staff voix)
- ✅ V0.5 — Polish UI (fils humains dashboard + narratif enrichi 4 paragraphes)
- ⬜ V0.9 — Bêta privée (Tauri, EULA, 5-10 testeurs)
- ⬜ V1.0 — Release Steam + Itch
